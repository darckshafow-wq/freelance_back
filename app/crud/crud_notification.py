...
from app.schemas.notification_schema import NotificationBase, NotificationCreate, NotificationUpdate
...
class CRUDNotification:
    ...
    def get_by_email(self, db: Session, email: str) -> Optional[Notification]:
        return db.query(Notification).filter(Notification.email == email).first()
